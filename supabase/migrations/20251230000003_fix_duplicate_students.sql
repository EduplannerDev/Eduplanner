-- Migration: 20251230000003_fix_duplicate_students.sql
-- Description: Fixes "duplicate key" error in Dashboard Pulse by ensuring unique students in the high-risk list.

-- 3. High Risk Students (SIAT style) - Deduplicate Students
